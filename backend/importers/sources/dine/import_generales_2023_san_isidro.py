"""Importer DINE — Generales 2023, categoría Presidente, circuitos de San Isidro.
...
Uso:
    PYTHONPATH=. python3 importers/sources/dine/import_generales_2023_san_isidro.py
"""
...
def run() -> Path:
    ...
    manifest = {
        ...
        "tipo_eleccion": TIPO_ELECCION["GENERAL"],
    ...
    mapa = client.get_mapa_departamentos(anio=ANIO, id_eleccion=TIPO_ELECCION["GENERAL"], id_cargo=CATEGORIA_PRESIDENTE)
